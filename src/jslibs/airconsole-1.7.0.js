...
c);else{if(""==b.responseType||"text"==b.responseType||"json"==b.responseType)a._xmlHttpRequestRetryRanger.response+=b.response}else throw"Response didn't include Content-Range header";p(a,d,!1);if(e<a._xmlHttpRequestRetryRanger.total-1){d=new k;d.responseType=b.responseType;var f=Math.min(e+a._xmlHttpRequestRetryRanger.config.CHUNK_SIZE,a._xmlHttpRequestRetryRanger.total-1);q(a,d,e+1,f);r(a,d,e+1,f);f==a._xmlHttpRequestRetryRanger.total-1&&v(a,d);d.send()}}});a._xmlHttpRequestRetryRanger.lastLoaded=
0;b.addEventListener("progress",function(c){if(0!=b.status){var e=c.loaded-a._xmlHttpRequestRetryRanger.lastLoaded;a._xmlHttpRequestRetryRanger.lastLoaded+=e;a._xmlHttpRequestRetryRanger.loaded+=e;c=h("progress",c,a);a._xmlHttpRequestRetryRanger.progressComplete=c.loaded==c.total;g(a._xmlHttpRequestRetryRanger.listeners.progress,c)}});b.addEventListener("error",function(d){a._xmlHttpRequestRetryRanger.loaded-=a._xmlHttpRequestRetryRanger.lastLoaded;a._xmlHttpRequestRetryRanger.lastLoaded=0;var u=
a._xmlHttpRequestRetryRanger.retries;u<a._xmlHttpRequestRetryRanger.config.RETRY?window.setTimeout(function(){var d=new k;f&&w(a,d,c,e);d.responseType=b.responseType;a._xmlHttpRequestRetryRanger.retries+=u+1;q(a,d,c,e);r(a,d,c,e,f);0!=c&&e==a._xmlHttpRequestRetryRanger.total-1&&v(a,d);d.send()},a._xmlHttpRequestRetryRanger.config.RETRY_BACKOFF):(a._xmlHttpRequestRetryRanger.readyState=4,a._xmlHttpRequestRetryRanger.status=0,g(a._xmlHttpRequestRetryRanger.listeners.readystatechange,z("readystatechange",
d,a)),g(a._xmlHttpRequestRetryRanger.listeners.progress,h("progress",d,a)),g(a._xmlHttpRequestRetryRanger.listeners.error,h("error",d,a)),g(a._xmlHttpRequestRetryRanger.listeners.loadend,h("loadend",d,a)))});x(a,"timeout")},v=function(a,b){b.addEventListener("readystatechange",function(c){4==b.readyState&&0!=b.status&&p(a,c,!0)})},w=function(a,b,c,e){a._xmlHttpRequestRetryRanger.retries=0;b.addEventListener("readystatechange",function(c){if(2==b.readyState)if(a._xmlHttpRequestRetryRanger.status=b.status,
a._xmlHttpRequestRetryRanger.statusText=b.statusText,l(a,b)){var d;if(d=a._xmlHttpRequestRetryRanger.config.USE_PSEUDO_RANGE_HEADERS?b.getResponseHeader("x-retry-ranger-content-range"):b.getResponseHeader("content-range")){d=d.split("/")[1];if("*"==d)throw"Response didn't include total Content-Range size";d=parseInt(d)}else throw"Response didn't include Content-Range header";a._xmlHttpRequestRetryRanger.total=d;a._xmlHttpRequestRetryRanger.firstRequest=b;if("arraybuffer"==b.responseType)a._xmlHttpRequestRetryRanger.response=
new Uint8Array(d);else if(""==b.responseType||"text"==b.responseType||"json"==b.responseType)a._xmlHttpRequestRetryRanger.response="";else throw"responseType "+b.responseType+" not supported";}else a._xmlHttpRequestRetryRanger.total=0,a._xmlHttpRequestRetryRanger.response="",a._xmlHttpRequestRetryRanger.firstRequest=b;4==b.readyState?0!=b.status&&(e>=a._xmlHttpRequestRetryRanger.total-1||!l(a,b))&&(l(a,b)||(a._xmlHttpRequestRetryRanger.pending=!1),p(a,c,!0)):a._xmlHttpRequestRetryRanger.readyState<
b.readyState&&(a._xmlHttpRequestRetryRanger.readyState=b.readyState,g(a._xmlHttpRequestRetryRanger.listeners.readystatechange,m(c,a)))})},q=function(a,b,c,e){for(var f=[],d=0;d<a._xmlHttpRequestRetryRanger.open_arguments.length;++d)1!=d?f.push(a._xmlHttpRequestRetryRanger.open_arguments[d]):f.push(a._xmlHttpRequestRetryRanger.config.URL_REWRITE(a._xmlHttpRequestRetryRanger.open_arguments[d],c,e,a._xmlHttpRequestRetryRanger.retries));f=b.open.apply(b,f);d="range";a._xmlHttpRequestRetryRanger.config.USE_PSEUDO_RANGE_HEADERS&&
(d="x-retry-ranger-range");b.setRequestHeader(d,"bytes="+c+"-"+e);return f},p=function(a,b,c){c&&(a._xmlHttpRequestRetryRanger.readyState=4);4!=a._xmlHttpRequestRetryRanger.readyState||a._xmlHttpRequestRetryRanger.pending||(a._xmlHttpRequestRetryRanger.progressComplete||g(a._xmlHttpRequestRetryRanger.listeners.progress,h("progress",b,a,!0)),g(a._xmlHttpRequestRetryRanger.listeners.readystatechange,m(b,a)),g(a._xmlHttpRequestRetryRanger.listeners.load,h("load",b,a,!0)),g(a._xmlHttpRequestRetryRanger.listeners.loadend,
h("loadend",b,a,!0)))},x=function(a,b){a.addEventListener(b,A(a,b))},A=function(a,b){return function(c){g(a._xmlHttpRequestRetryRanger.listeners[b],c)}},g=function(a,b){if(a.on)a.on(b);for(var c=0;c<a.listeners.length;++c)a.listeners[c](b)},h=function(a,b,c,e){return new Proxy(m(b,c),{get:function(b,d){return"lengthComputable"==d?0<c._xmlHttpRequestRetryRanger.total:"total"==d?c._xmlHttpRequestRetryRanger.total:"loaded"==d?e?c._xmlHttpRequestRetryRanger.total:c._xmlHttpRequestRetryRanger.loaded:"type"==
d?a:b[d]},set:function(a,b,c){a[b]=c;return!0}})},z=function(a,b,c){return new Proxy(m(b,c),{get:function(b,c){return"type"==c?a:b[c]},set:function(a,b,c){a[b]=c;return!0}})},m=function(a,b){return new Proxy(a,{get:function(a,e){return"target"==e||"currentTarget"==e?b._xmlHttpRequestRetryRanger.proxy:"function"==typeof a[e]?function(){return a[e].apply(a,arguments)}:a[e]},set:function(a,b,f){a[b]=f;return!0}})},l=function(a,b){return 206==b.status||a._xmlHttpRequestRetryRanger.config.USE_PSEUDO_RANGE_HEADERS&&
200==b.status},t={CHUNK_SIZE:5242880,MATCH:function(a){return!0},ACTIVE:function(){var a=["Chrome","Safari","Firefox","Edge"];if(navigator.userAgent)for(var b=0;b<a.length;++b)if(-1!=navigator.userAgent.indexOf(a[b]+"/"))return!0;return!1},RETRY:3,RETRY_BACKOFF:1E3,URL_REWRITE:function(a,b,c,e){return a},USE_PSEUDO_RANGE_HEADERS:!1},n={loadstart:!0,progress:!0,load:!0,loadend:!0,error:!1,timeout:!1,readystatechange:!1},k=XMLHttpRequest,B={set:function(a,b,c){0==b.indexOf("on")&&void 0!==a._xmlHttpRequestRetryRanger.listeners[b.substr(2)]?
(a=a._xmlHttpRequestRetryRanger.listeners[b.substr(2)],a.on&&delete a.on,c&&(a.on=c)):("responseType"==b&&(a._xmlHttpRequestRetryRanger.responseType=c,"json"==c&&(c="")),a[b]=c);return!0},get:function(a,b){var c=!!a._xmlHttpRequestRetryRanger.open_arguments;if("open"==b)return function(){var c=arguments[1];if("GET"==arguments[0].toUpperCase()&&!1!==arguments[2]&&a._xmlHttpRequestRetryRanger.config.MATCH(c)){a._xmlHttpRequestRetryRanger.open_arguments=arguments;c=a._xmlHttpRequestRetryRanger.config.CHUNK_SIZE-
1;w(a,a,0,c);var f=q(a,a,0,c);r(a,a,0,c,!0);return f}a.responseType=a._xmlHttpRequestRetryRanger.responseType||"";for(f in n)x(a,f);return a[b].apply(a,arguments)};if("addEventListener"==b)return function(){if(void 0!==n[arguments[0]])a._xmlHttpRequestRetryRanger.listeners[arguments[0]].listeners.push(arguments[1]);else return a[b].apply(a,arguments)};if("removeEventListener"==b)return function(){if(void 0!==n[arguments[0]])for(var c=a._xmlHttpRequestRetryRanger.listeners[arguments[0]].listeners,
...
/*
 ...
 @git:
*/
(function(){if(window.Proxy){var d=XMLHttpRequest;window.XMLHttpRequest=function(c){var e,f,g=new d(c);if(window.xmlHTTPRequestGlobalCallbacks)for(var h in window.xmlHTTPRequestGlobalCallbacks)(function(a){g.addEventListener(a,function(b){window.xmlHTTPRequestGlobalCallbacks[a](b,e,f)})})(h);return new Proxy(g,{get:function(a,b){return"open"==b?function(){e=arguments[0];f=arguments[1];return a[b].apply(a,arguments)}:"function"==typeof a[b]?function(){return a[b].apply(a,arguments)}:a[b]},set:function(a,
b,c){a[b]=c;return!0}})};for(var c in d)window.XMLHttpRequest[c]=d[c]}})();

window.xmlHttpRequestRetryRanger={CHUNK_SIZE:8388608,MATCH:function(a){return 0==a.indexOf("Build/")&&a.endsWith(".unityweb")||-1!=a.indexOf("StreamingAssets/")&&a.endsWith(".unity3d")||0==a.indexOf("Release/")&&(a.endsWith(".js")||a.endsWith(".jsgz")||a.endsWith(".mem")||a.endsWith(".memgz")||a.endsWith(".data")||a.endsWith(".datagz"))},ACTIVE:function(){if((window.onGameReady||window.UnityLoader)&&"game.airconsole.com"==document.location.hostname&&document.location.pathname.endsWith("screen.html")){var a=
["Chrome","Safari","Firefox","Edge"];if(navigator.userAgent)for(var b=0;b<a.length;++b)if(-1!=navigator.userAgent.indexOf(a[b]+"/"))return!0}return!1},USE_PSEUDO_RANGE_HEADERS:!0,URL_REWRITE:function(a,b,c,d){d=a.split("#");var e=d[0];a=void 0;void 0!=d[1]&&(d.shift(),a=d.join("#"));e=-1==e.indexOf("?")?e+"?":e+"&";b=e+("xmlhttprequest-ranger-start="+b+"&xmlhttprequest-ranger-end="+c);void 0!=a&&(b+="#"+a);return b}};
window.xmlHTTPRequestGlobalCallbacks={error:function(a,b,c){c.match(/\.unityweb$/)&&(a=new XMLHttpRequest,a.onload=function(){AirConsole.postMessage_({action:"set",key:"xmlhttprequest_status",value:{status:"error",url:c}})},a.open("GET","/games.airconsole.com/cdn/cdn.js?ts="+(new Date).getTime(),!0),a.send())},load:function(a,b,c){c.match(/\.unityweb$/)&&AirConsole.postMessage_({action:"set",key:"xmlhttprequest_status",value:{status:"load",url:c}})}};
